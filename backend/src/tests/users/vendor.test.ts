...
// import { compareExisting, prepareVendorDetails, testNew } from "../util/usersHelper";
...
//     // Send the request
//     const response: request.Response = await request(app).post("/api/vendors").send(requestBody);
...
//     // Send the request
//     const response: request.Response = await request(app).patch("/api/vendors").send(requestBody);
